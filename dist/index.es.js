...
var BoilerplateReactTsComponent = /** @class */ (function (_super) {
    ...
    BoilerplateReactTsComponent.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({ "data-component": CLASS_NAME, className: classnames(CLASS_NAME, className) }, props),
            React.createElement("p", null,
                React.createElement("button", { style: { padding: 20, width: '100%' }, onClick: this.handleClick, className: "icon-play" }, "Enjoy coding."))));
    };
